...
from OrderingStrategy import NoOrdering
...
class MsgHandler(threading.Thread):
  def __init__(self, sock, ordering):
  ...
  def run(self):
    ...
    handshake_event.set()   # avisa a thread principal que já recebeu todos
    ...
    while True:                
      ...
      if msg[0] == -1:   # count the 'stop' messages from the other processes
        ...
        self.ordering.deliver(msg, logList)
...
while 1:
  ...
  msgHandler = MsgHandler(recvSocket, NoOrdering())
  msgHandler.start()
